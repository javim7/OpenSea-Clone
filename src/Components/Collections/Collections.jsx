...
function Collections() {
  const column1 = [
    { rate: '1', name: 'Otherdeed for Oth...', img: Azuki, floor: '2.6', percent: '-81.49%', price: '39,076.93', id: 'pctMinus' },
    { rate: '2', name: 'Azuki', img: Azuki, floor: '7.5', percent: '+298.21%', price: '31,818.45', id: 'pctPlus' },
    { rate: '3', name: 'PXN: Ghost Division', img: Azuki, floor: '3.65', percent: '-', price: '24,673.15', id: 'pctSame' },
    { rate: '4', name: 'BEANZ Official', img: Azuki, floor: '1', percent: '+303.03%', price: '12,666.59', id: 'pctPlus' },
    { rate: '5', name: 'Bored Ape Yatch C...', img: Azuki, floor: '89.95', percent: '-64.97%', price: '12,541.57', id: 'pctMinus' },
  ]
  const column2 = [
    { rate: '6', name: 'Mutant Ape Yatch C...', img: Azuki, floor: '19.5', percent: '-65.86%', price: '11,995.7', id: 'pctMinus' },
    { rate: '7', name: 'Doodles', img: Azuki, floor: '16.98', percent: '+4.01%', price: '8,822.18', id: 'pctPlus' },
    { rate: '8', name: 'OkayBears', img: Azuki, floor: '119', percent: '-35.10%', price: '336,053.27', id: 'pctMinus' },
    { rate: '9', name: 'Moonbirds', img: Azuki, floor: '22.9', percent: '-35.41%', price: '7,154.45', id: 'pctMinus' },
    { rate: '10', name: 'CLONE X- X TAKAS...', img: Azuki, floor: '13.25', percent: '-17.05%', price: '6,452.14', id: 'pctMinus' },
  ]
  const column3 = [
    { rate: '11', name: 'Art Blocks Curated', img: Azuki, floor: '5.69', percent: '+126.02%', price: '5,886.87', id: 'pctPlus' },
    { rate: '12', name: 'Ragnarok Meta', img: Azuki, floor: '0.9', percent: '-48.42%', price: '4,819.18', id: 'pctMinus' },
    { rate: '13', name: 'ENS: Ethereum Na...', img: Azuki, floor: '-', percent: '-59.87%', price: '4,071.55', id: 'pctMinus' },
    { rate: '14', name: 'Murakami.Flower...', img: Azuki, floor: '3.88', percent: '-34.12%', price: '3,838.45', id: 'pctMinus' },
    { rate: '15', name: 'Mindblown Unive...', img: Azuki, floor: '0.29', percent: '-', price: '3,322.78', id: 'pctMinus' },
  ]
